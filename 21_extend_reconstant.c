...
#define Target_diva_map_min 1e-9//1e-10//1e-17
...
int main(void)
{
    ...
    length_ele_extended = sizeof(stack) / sizeof(stack[0]) * 6; //5 //4种^
...
//--------------------------------single_thread_gen-----------------------------------------//
    ...
    for (i = 0; i < length_ele; i++)
    {
        ...
        stack_extended[i + 2 * length_ele] = powl(stack[i], 2);
        stack_extended[i + 3 * length_ele] = powl(stack[i], 3);
        stack_extended[i + 4 * length_ele] = powl(stack[i], 4);
        stack_extended[i + 5 * length_ele] = powl(stack[i], 1./3);
    }
