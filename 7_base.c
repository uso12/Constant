...
#endif
#ifndef multi_thread
    #define max1 373621248 //buffer_original
    double *buffer_original,*buffer_original_save;//原始数组
    double *buffer_shrink,*buffer_shrink_save;//删除后留下的数组
    long int total_pushed = 0;  //数组排序删前的个数
    long int zero =0;
#endif
/*double stack[] = {Planck_length,Proton_length,Proton_mass,Planck_mass,
                            Planck_time,Speed_of_light,Charge,Avogadro_constant,
                            Chaos_costant,Planck_constant,Pi,Gravitational_constant,Boltzmann_constant};*///self_old
...
int length_ele = 16;//how to calculate : printf("%d\n",sizeof(stack) / sizeof(stack[0]));
int length_ele_extended = 16*5;
//-------------------------------------------------------------------------------------------------//
//用户函数
